...
export function InventoryItemCard({
  ...
  return (
    <div
      ...
      className="group flex h-full select-none cursor-grab items-center justify-center p-1 active:cursor-grabbing"
    >
      <div
        className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-xl border border-white/15 bg-white/5 p-2 transition hover:border-cyan-200/50"
