...
export const ORK_ANIMATION_CONFIG: MonsterAnimationConfig = {
  keyframePrefix: "ork",
...
const ORK_STAT_RANGES: MonsterStatRanges = {
  base: {
    [CharacteristicsEnum.HP]: [70, 70],
    [CharacteristicsEnum.MP]: [20, 20],
    [CharacteristicsEnum.PHYS_RESIST]: [5, 5],
    ...
    [CharacteristicsEnum.EVASION]: [10, 10],
    [CharacteristicsEnum.VAMPIRIC]: [2, 2],
  },
  growth: {
    [CharacteristicsEnum.HP]: [30, 30],
    ...
    [CharacteristicsEnum.MAGIC_ATK]: [2, 2],
...
export const ORK_CHARACTERISTICS = createRandomCharacteristics(
  1107,
  ORK_STAT_RANGES,
);
